...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def main(self):
        ...
        self.config = config
        self.options.bitcoind = os.getenv("FEATHERCOIND", default=config["environment"]["BUILDDIR"] + '/src/omnifeatherd' + config["environment"]["EXEEXT"])
        self.options.bitcoincli = os.getenv("FEATHERCOINCLI", default=config["environment"]["BUILDDIR"] + '/src/omnifeather-cli' + config["environment"]["EXEEXT"])
