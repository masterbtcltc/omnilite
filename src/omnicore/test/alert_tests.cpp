...
BOOST_AUTO_TEST_CASE(alert_positive_authorization)
{
    ...
    BOOST_CHECK(CheckAlertAuthorization("6eXoDUSUV7yrAxKVNPEeKAHMY8San5Z37V"));
}
...
BOOST_AUTO_TEST_CASE(alert_manual_sources)
{
    ...
    BOOST_CHECK(CheckAlertAuthorization("6eXoDUSUV7yrAxKVNPEeKAHMY8San5Z37V")); // should still be authorized
    BOOST_CHECK(!CheckAlertAuthorization("1JwSSubhmg6iPtRjtyqhUYYH7bZg3Lfy1T"));
